...
class Urlsss {
  ...
  static const String loginUrl = "${baseUrl}userapp/login/";
  static const String listJobs = "${baseUrl}userapp/companies/";
  static const String listjobDetails = "${baseUrl}userapp/job_by_company/";
  static const String postLeaveRequest = "${baseUrl}userapp/student-requests/";
